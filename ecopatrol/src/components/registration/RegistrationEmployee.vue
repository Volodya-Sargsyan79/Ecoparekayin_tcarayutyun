<template>
    <form class="box">
        <h3 class="title is-5 has-text-centered mb-4">ԷՊԾ աշխատակից</h3>
        <div class="columns">
            <div class="column">
                <div class="field">
                    ...
                    <p v-if="!form.name" class="help is-danger">Պարտադիր է մուտքագրել անունը</p>
                </div>
            </div>
            <div class="column">
                <div class="field">
                    ...
                    <p v-if="!form.surname" class="help is-danger">Պարտադիր է մուտքագրել ազգանունը</p>
                </div>
            </div>
            <div class="column">
                <div class="field">
                    ...
                    <p v-if="!form.phone" class="help is-danger">Պարտադիր է մուտքագրել հեռախոսահամարը</p>
                </div>
            </div>
            <div class="column">
                <div class="field">
                    ...
                    <p v-if="!form.camera" class="help is-danger">Պարտադիր է մուտքագրել տեսախցիկի համարը</p>
            ...
            <div class="control">
                <div class="select is-fullwidth">
                    <select v-model="form.position_id">
                        <option value="">Ընտրել</option>
                        <option v-for="position in $store.state.user.position" :key="position.id" :value="position.id">{{ position.position_held }}</option>
                    </select>
                </div>
            </div>
             <p v-if="!form.position_id" class="help is-danger">Պարտադիր է ընտրել պաշտոնը</p>
        </div>
        <div class="field mt-5 has-text-centered">
            <button type="submit" class="button is-primary is-medium" @click.prevent="saveEmployee">Պահպանել</button>
        </div>
    </form>                     
</template>
    ...
    name: 'EpsEmployeeForm',
        ...
        methods: {
            ...
            saveEmployee() {
                ...
                axios.post("/api/ecopatrol/addEmployee/", payload)
                    .then(() => {
                        axios
