<template>
    <form class="box">
        <h3 class="title is-5 has-text-centered mb-4">Երթուղու գրանցում</h3>
        <div class="columns">
            <div class="column">
                <div class="field">
        ...
        <div class="columns">
             <div class="column">
                <div class="field">
                    ...
                    <p v-if="!form.route_number" class="help is-danger">Պարտադիր է մուտքագրել անունը</p>
                </div>
            </div>
            <div class="column">
                <div class="field">
                    ...
                    <p v-if="!form.route_length" class="help is-danger">Պարտադիր է մուտքագրել ազգանունը</p>
                </div>
            </div>
            <div class="column">
                <div class="field">
    ...
    export default {
        ...
        methods: {
            ...
            saveCall() {
                ...
                axios
                    .post('/api/ecopatrol/addroute/', formData, {
                        headers: {
